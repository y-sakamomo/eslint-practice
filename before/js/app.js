$(function () {
  ...
  function displayResult(r) {
    ...
    if(r[0].items === undefined || r[0].items.length === 0) {
      ...
      $.each(r[0].items, function (_, item) {
        // それぞれの値を定義し、値がないときは不明をとする
        ...
        const listText = `<li class="lists-item"><div class="list-inner"><p>タイトル：${title}</p><p>作者：${creator}</p><p>出版社：${publisher}</p><a href="${id}">書籍情報</a></div></li>`;
